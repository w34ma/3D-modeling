...
public:
	...
	void DrawBoundingBox();								// custom control handle drawing, called in DrawScene function
...
public:
	...
	bool	m_bAntialiasing;							// anitaliasing	
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	void UserDrawControlHandle(V3 origin, V3 x_axis, V3 y_axis, V3 z_axis);
	// Given the screen coordinates, return the coordinates in world coordinate system
	V3 ProjectScreenPoint(int x, int y);
};
